package upraxis.com.task.commons;
...
public class ErrorMessages {
    ...
    /** headers */
    public static final String ERROR_NO_CONNECTION_HEADER = "Connection Error";

    /** messages */
    public static final String ERROR_NO_CONNECTION_MESSAGE = "Please check your network connection and try again.";
